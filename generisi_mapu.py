...
Skripta nije deo servera i ne dira bazu — pokreće se posle instalacije ili kad
se promeni raspored (RED_KRIVE / DIMENZIJA u webapp/core/mapa.py).
"""
...
def generisi_sloj(naziv, izlaz):
    ...
    t0 = time.time()
    mreza = mreza_osobine(naziv)
    vmin, vmax = mapa.OSOBINE[naziv]["opseg"]
    pal = paleta()
